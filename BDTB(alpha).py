...
#response.read().decode('utf-8')
    ...
    def getTitle(self, page):
        ...
        title = re.findall(b'class="core_title_txt.*?>(.*?)</h', page)
    ...
    def getPageNum(self, page):
        ...
        result = re.findall(
            b'<li class="l_reply_num.*?</span>.*?<span.*?>(.*?)</span>', page)
    ...
    def setFileTitle(self, title):
        ...
        if title is not None:
            ...
            self.file = codecs.open(
                self.defaultTitel + ".txt", "wU", encoding="utf-8")
...
#            self.floor += 1
    ...
    def getFig(self, page, title):
        ...
        img_urls = re.findall(b'class="BDE_Image".*?src="(.*?)"', page)
...
while True:
    ...
    if floorTag == '1' or floorTag == '0':
        break
"""
baseURL = "https://tieba.baidu.com/p/5107094720"
seeLZ = 1
floorTag = 1
